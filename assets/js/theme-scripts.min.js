...
b&&(c.value=b-parseFloat(f));a=new Event("change",{bubbles:!0});c.dispatchEvent(a)}});function datTopFunction(){document.body.scrollTop=0;document.documentElement.scrollTop=0}window.addEventListener("load",function(){var a=document.getElementById("scrollTopButton");window.onscroll=function(){a.style.display=20<document.body.scrollTop||20<document.documentElement.scrollTop?"flex":"none"}});